<template>
  <div class="site2_contanier">
    <el-page-header @back="goBack" content="Jane’s Office (PAR 104. 230)"> </el-page-header>
    <div id="myChart"></div>
    <div id="myChartP"></div>
    <div id="myChart2"></div>
  </div>
...
export default {
  ...
  methods: {
    ...
    echartsInit() {
      ...
      $.get('https://test-eagle.oss-cn-shenzhen.aliyuncs.com/zdG0Ga/Fianl_janes.json', function(_rawData) {
