<template>
  <div class="site2_contanier">
    <el-page-header @back="goBack" content="Union House"> </el-page-header>
    <div id="myChart"></div>
    <div id="myChartP"></div>
    <div id="myChart2"></div>
  </div>
...
export default {
  ...
  methods: {
    ...
    echartsInit() {
      ...
      $.get('https://test-eagle.oss-cn-shenzhen.aliyuncs.com/zgimLK/unihoused.json', function(_rawData) {
