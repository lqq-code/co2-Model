<template>
  <div class="site2_contanier">
    <el-page-header @back="goBack" content="McCoy Building"> </el-page-header>
    <div id="myChart"></div>
    <div id="myChartP"></div>
    <div id="myChart2"></div>
  </div>
...
export default {
  ...
  methods: {
    ...
    echartsInit() {
      ...
      $.get('https://test-eagle.oss-cn-shenzhen.aliyuncs.com/zdG0Ga/final_maccoy.json', function(_rawData) {
