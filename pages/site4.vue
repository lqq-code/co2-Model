<template>
  <div class="site2_contanier">
    <el-page-header @back="goBack" content="Chemistry laboratory"> </el-page-header>
    <div id="myChart"></div>
    <div id="myChartP"></div>
    <div id="myChart2"></div>
  </div>
...
export default {
  ...
  methods: {
    ...
    echartsInit() {
      ...
      $.get('https://test-eagle.oss-cn-shenzhen.aliyuncs.com/notarization/chemlabd.json', function(_rawData) {
